...
object AppConfig {
    ...
    const val APP_URL = "https://boltvpn.store"
    const val APP_API_URL = ""
    const val APP_ISSUES_URL = "https://boltvpn.store/support"
    const val APP_WIKI_MODE = ""
    const val APP_PRIVACY_POLICY = "https://boltvpn.store/privacy"
    const val APP_PROMOTION_URL = ""
    const val TG_CHANNEL_URL = "https://t.me/boltvpn_channel"
...
//    const val IP_API_URL = "https://speed.cloudflare.com/meta"
    ...
    const val RAY_NG_CHANNEL_ID = "BOLT_VPN_CH_ID"
    const val RAY_NG_CHANNEL_NAME = "Bolt VPN Background Service"
